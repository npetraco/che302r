...
N.A  <- 6.02214076e23         # Avogadro's number
me   <- 9.1093837015e-31      # mass of electron
ec   <- 1.60217663e-19        # charge of electron in Coulombs
RH   <- 109625                # Rydberg constant in wavenumbers
RHJ  <- h * cl/( 1/(RH*100) ) # Rydberg constant in Joules
